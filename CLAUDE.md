...
- ยังไม่ได้ทำ: ล็อกอินแอปแอดมินด้วย LINE โดยตรง (ตอนนี้ยัง username/password + ผูก LINE id ไว้เฉยๆ)
  และการยืนยันว่า LINE id ที่กรอกตอนสมัครเป็นของคนกรอกจริง — ใช้การอนุมัติของผู้ดูแลเป็นด่านตรวจแทน
